    ...
    return inquirer
        .prompt([
            { // There is only 1 manager for a team.
                type: "input",
                message: "Who is the head honcho of this project? (Required)",
                name: "employee",
                validate(employee) {
            ...
            },
            {
                type: 'text',
                name: 'id',
                message: "What is the head honchos's ID number? (Required)",
                validate(id) {
                    if (validator.isNumeric(id)) {
                        return true;
                    } else {
                        console.log('You must enter a numeric value dummy!');
                        return false;
                    }
                }
            },
            {
                type: 'text',
                name: 'email',
                message: "What is the head cheese's email? (Required)",
                validate(email) {
            ...
            },
            {
                type: 'input',
                name: 'office',
                message: "What is the Head Cheese office number? (Required)",
                validate(office) {
